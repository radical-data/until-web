...
<svelte:head>
	...
	<meta
		name="description"
		content="Until: A community-led database of Palestinians killed in the Israeli assault on Gaza. This database humanizes each individual beyond numbers, offering names, images, and stories. Contribute by submitting sources, images or testimonials."
	/>
</svelte:head>
